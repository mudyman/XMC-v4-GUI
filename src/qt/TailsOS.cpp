...
void TailsOS::showDataPersistenceDisabledWarning()
{
    ...
    msgBox.setInformativeText(
        QObject::tr("Monero Classic GUI has detected that Tails persistence is "
                     "currently disabled. Any configurations you make inside "
                     "the Monero Classic GUI will not be saved."
                     "\n\n"
...
{
    QMessageBox msgBox;
    msgBox.setWindowTitle(QObject::tr("Monero Classic GUI"));
